        ...
        <div className="row">
            ...
            {openedUserTab && (
                ...
                >
                    ...
                    {users.map((usr, index) => (
                            <p key={index* 999} className="my-2 w-100 text-center py-2 border border-left-0 border-right-0">
